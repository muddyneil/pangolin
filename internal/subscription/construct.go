...
func Build(nodes []Proxy) Output {
	...
	return Output{MixedPort: 7890, Mode: "rule", UnifiedDelay: true, TCPConcurrent: true, Proxies: nodes, Groups: groups, Rules: []string{"DOMAIN-SUFFIX,openai.com,AI-POOL", "DOMAIN-SUFFIX,chatgpt.com,AI-POOL", "DOMAIN-SUFFIX,anthropic.com,AI-POOL", "GEOIP,CN,DIRECT", "MATCH,PROXY"}, Metadata: map[string]string{"generated-by": "pangolin " + version.Version, "generated-at": time.Now().UTC().Format(time.RFC3339)}}
}
